...
class FacilidadesScreen extends React.Component {
        ...
        <View style={[styles.box, styles.box1]}>
          ...
          >
            <View style={styles.touchableContent}>
              ...
              <Text style={styles.optionText}>Clínicas y Hospitales</Text>
            </View>
          </Touchable>
        </View>
        <View style={[styles.box, styles.box2]}>
          ...
          >
            <View style={styles.touchableContent}>
              ...
              <Text style={styles.optionText}>Requisitos</Text>
            </View>
          </Touchable>
        </View>
        <View style={[styles.box, styles.box3]}>
          ...
          >
            <View style={styles.touchableContent}>
              ...
              <Text style={styles.optionText}>Métodos</Text>
            </View>
          </Touchable>
        </View>
        <View style={[styles.box, styles.box4]}>
          ...
          >
            <View style={styles.touchableContent}>
              ...
              <Text style={styles.optionText}>Procesos</Text>
            </View>
          </Touchable>
        </View>
        <View style={[styles.box, styles.box5]}>
          ...
          >
            <View style={styles.touchableContent}>
              ...
              <Text style={styles.optionText}>Cuidados</Text>
            </View>
          </Touchable>
        </View>
