...
class NormatividadScreen extends React.Component {
        ...
        <View style={[styles.box, styles.box2]}>
          ...
          >
            <View style={styles.touchableContent}>
              ...
              <Text style={styles.optionText}>Ley General de Víctimas</Text>
            </View>
          </Touchable>
        </View>
        <View style={[styles.box, styles.box3]}>
          ...
          >
            <View style={styles.touchableContent}>
              ...
              <Text style={styles.optionText}>Ley General de Salud</Text>
            </View>
          </Touchable>
        </View>
        <View style={[styles.box, styles.box4]}>
          ...
          >
            <View style={styles.touchableContent}>
              ...
              <Text style={styles.optionText}>NOM-046</Text>
            </View>
          </Touchable>
        </View>
        <View style={[styles.box, styles.box5]}>
          ...
          >
            <View style={styles.touchableContent}>
              ...
              <Text style={styles.optionText}>Código Penal Federal</Text>
            </View>
          </Touchable>
        </View>
